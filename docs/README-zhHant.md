...
> ### 概述:
>
> - 若為非營利目的，可以自由地使用這裡的 logo。例如：製作成貼紙自用、使用在IDE的icon等。
...
1. 這些logo的創作者是澤原月(Sawaratsuki)。 這並不意味著版權已被完全放棄。
2. 請檢查以下項目:
   > - 建議附上版權資訊。這會給作者動力，所以請盡量這樣做。
   > - 可以修改和重新混合。
   > - 禁止用於商業目的（使用該標誌的發行產品等行為）。 但是，如果屬於以下指定的項目，則允許進行營利。
   >
   > 1. 如果各服務官方想要將logo用於商業目的產品
   > 2. 如果澤原月允許的話 >（如發現違規行為，請立即聯絡[@Sawaratsuki](https://x.com/sawaratsuki1004)！）
3. 將貼圖、貼紙等用於個人用途可以不用經過許可！
...
如果每種語言的 README 不一致，則以日文版的 README 為準。
